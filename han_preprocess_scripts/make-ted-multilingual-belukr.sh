...
# Han: CHANGE ME!!!
RAW_DDIR=han_data/ted_raw_belukr_sepspm"$VOCAB_SIZE"/ # Han: change this for different data setup
PROC_DDIR=han_data/ted_processed/belukr_sepspm"$VOCAB_SIZE"/ # Han: change this for different data setup
BINARIZED_DDIR=fairseq/data-bin/ted_belukr_sepspm"$VOCAB_SIZE"/ # Han: change this for different data setup
