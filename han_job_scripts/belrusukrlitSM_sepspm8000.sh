...
# Han: CHANGE ME!!!
DATA_DIR=fairseq/data-bin/ted_belrusukrlitSM_sepspm8000/M2O/
MODEL_DIR=fairseq/checkpoints/ted_belrusukrlitSM_sepspm8000/M2O/
...
CUDA_VISIBLE_DEVICE=$CUDA_DID fairseq-train \
	...
	--lang-pairs bel-eng,rus-eng,ukr-eng,lit-eng \
	--max-epoch 40 \
...
# Han: CHANGE ME!!!
DATA_DIR=fairseq/data-bin/ted_belrusukrlitSM_sepspm8000/O2M/
MODEL_DIR=fairseq/checkpoints/ted_belrusukrlitSM_sepspm8000/O2M/
...
CUDA_VISIBLE_DEVICE=$CUDA_DID fairseq-train \
	...
	--task translation_multi_simple_epoch \
 	--encoder-langtok tgt \
	--lang-pairs eng-bel,eng-rus,eng-ukr,eng-lit \
	--max-epoch 40 \
        --distributed-world-size 1 \
	--share-all-embeddings \
	--no-epoch-checkpoints \
