...
DATA_DIR=fairseq/data-bin/ted_belrus_sepspm8000/O2M/
MODEL_DIR=fairseq/checkpoints/ted_belrus_sepspm8000/O2M/
mkdir -p $MODEL_DIR

# train the model
CUDA_VISIBLE_DEVICE=2,3 fairseq-train \
	$DATA_DIR \
...
CUDA_VISIBLE_DEVICE=2,3 fairseq-generate $DATA_DIR \
          --gen-subset test \
	  --task translation_multi_simple_epoch \
	  --lang-pairs eng-bel,eng-rus \
 	  --encoder-langtok tgt \
