...
# This file trains aze with it's phonetics in a multilingual setting

DATA_DIR=fairseq/data-bin/ted_azeazp_sepspm8000/M2O/
MODEL_DIR=fairseq/checkpoints/ted_azeazp_sepspm8000/M2O/
mkdir -p $MODEL_DIR
