...
UPSAMPLE=8
DATA_DIR=fairseq/data-bin/ted_bel_spm8000/eng_bel_plus_bt_"$SUBSAMPLE_SIZE"/
MODEL_DIR=fairseq/checkpoints/ted_bel_spm8000/eng_bel_plus_bt_"$SUBSAMPLE_SIZE"_upsample_"$UPSAMPLE"/
mkdir -p $MODEL_DIR
